@section('title', __('download_start.meta.title'))
@section('description', __('download_start.meta.description'))

@section('og:title', __('download_start.meta.title'))
@section('og:description',  __('download_start.meta.description'))
...
<div class="section mt-5">
    <div class="container">
        <div class="row d-flex flex-row">
            <div class="col-md-12">
                <h1 class="mb-4 font-weight-bold">{{ __('download_start.next_steps') }}</h1>
            </div>

            <div class="col-md-8 mb-5">
                <h6 class="mb-3">{{ __('download_start.install_vid') }}</h6>
            ...
            <div class="col-md-4 mb-5">
                <h6 class="mb-3">{{ __('download_start.community_join') }}</h6>
...
<div class="section mt-5 pt-5 pb-3 border-top dark-secondary text-white">
    <div class="container">
        ...
        <div class="row mb-4 mt-4">
            <div class="col-md-12">
                <h3 class="mb-4">{{ __('download_start.download_infos') }}</h3>
            </div>
            ...
            <div class="col-3 text-left mb-3">
                <h6>{{ __('download_start.version') }}</h6>
