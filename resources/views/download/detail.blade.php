@section('title', 'Download Nitrox · Subnautica Multiplayer Mod')
@section('description', 'Download Nitrox: a free multiplayer mod for the game Subnautica developed by the community.')

@section('og:title', 'Download Nitrox · Subnautica Multiplayer Mod')
@section('og:description', 'Download Nitrox: a free multiplayer mod for the game Subnautica developed by the community.')
    ...
    <div class="section home-cover cover-download overflow-hidden">
        <div class="container">
            ...
            <div class="col-md-8 text-left pb-3 pt-3">
                <span class="badge badge-primary">EARLY ALPHA</span>
                <h1 class="mt-3 font-weight-bold display-3">Download Nitrox</h1>
                <p class="lead opacity-75 mt-4">Your adventure awaits. Download the Nitrox Mod for free and start playing subnautica multiplayer!</p>
                    ...
                    <div class="col d-flex align-items-center my-4">
                        <a href="{{ route('download.start') }}" class="btn btn-lg btn-primary btn-rounded py-3 px-4 mr-4 ripple">
                            <div class="d-flex px-2">
                                ...
                                <div class="d-flex">Start Download</div>
                            </div>
                        </a>
                        <p class="opacity-75 mb-0 d-md-block d-none">Alpha&nbsp;{{ $version['version'] }}&nbsp;·&nbsp;{{ $version['filesize'] }} MB</p>
                    </div>
                </div>
                <p class="opacity-75 mb-0 d-md-none d-block">Alpha&nbsp;{{ $version['version'] }}&nbsp;·&nbsp;{{ $version['filesize'] }} MB</p>
            </div>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-md-12 text-center mb-2 mt-2">
                    <h6 class="text-white opacity-75">Supported Store Versions</h6>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8 mb-5">
                    <div class="white-secondary p-5">
                        <h1 class="font-weight-bold display-4">Changelog</h1>
                        ...
                        <a href="{{ route('pages.changelog') }}" class="btn ripple btn-link">View older changelog entries</a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12 text-left">
                            ...
                            Nitrox Mod. <span class="opacity-5">An open-source, multiplayer modification for the game Subnautica.</span></h3>
                        </div>
                    </div>
