<div class="section section home-cover cover-team pb-5" >
    <div class="container py-2">
        <div class="row">
            <div class="col-md-12 pb-4">
                <h6 class="pt-5 pb-5">{{ __('footer.footer-extended.community_title') }}</h6>
                <h2 class="font-weight-bold">{{ __('footer.footer-extended.community_description') }}</h2>
            </div>
        </div>

        <div class="row mb-4 mt-2 d-none d-md-flex">
            <div class="col-md-3 col-6 mb-3">
                <h1>{{ __('footer.footer-extended.user_count') }}</h1>
                <h6>{{ __('footer.footer-extended.users') }}</h6>
            </div>

            <div class="col-md-3 col-6 mb-3">
                <h1>{{ __('footer.footer-extended.download_count') }}</h1>
                <h6>{{ __('footer.footer-extended.downloads') }}</h6>
            </div>

            <div class="col-md-3 col-6 mb-3">
                <h1>{{ __('footer.footer-extended.nexus_views') }}</h1>
                <h6>{{ __('footer.footer-extended.nexus') }}</h6>
            </div>

            <div class="col-md-3 col-6 mb-3">
                <h1>{{ __('footer.footer-extended.discord_members') }}</h1>
                <h6>{{ __('footer.footer-extended.discord') }}</h6>
            </div>
        </div>
    </div>
</div>

<div class="section dark-secondary pt-5">
    <div class="container">
        <div class="row pt-5">
            <div class="col-md-6 mb-5">
                <div class="card card-hover dark-section">
                    <div class="card-body text-left p-5">
                        ...
                        <h5 class="card-title mt-3 font-weight-bold">{{ __('footer.footer-extended.community.discord') }}</h5>
                        <p class="card-text">{{ __('footer.footer-extended.community.discord_description') }}</p>
                        <a href="https://discord.gg/E8B4X9s" target="_blank" class="card-link font-weight-500 stretched-link">{{ __('footer.footer-extended.community.discord_join') }}<span class="material-icons" style="position: absolute;font-size: 20px;margin: 2px 0px 0px -2px;">chevron_right</span></a></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-5">
                <div class="card card-hover dark-section ">
                    <div class="card-body text-left p-5">
                        ...
                        <h5 class="card-title mt-3 font-weight-bold">{{ __('footer.footer-extended.community.twitter') }}</h5>
                        <p class="card-text">{{ __('footer.footer-extended.community.twitter_description') }}</p>
                        <a href="https://twitter.com/modnitrox" target="_blank" class="card-link font-weight-500 stretched-link">{{ __('footer.footer-extended.community.twitter_join') }} <span class="material-icons" style="position: absolute;font-size: 20px;margin: 2px 0px 0px -2px;">chevron_right</span></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="section section-dark text-white dark-secondary pt-5 pb-5">
    <div class="container pb-5">
        <div class="row d-flex mb-4 pt-4">
            <div class="col-md-12">
                <h3 class="mb-4 mt-5 font-weight-bold">{{ __('footer.footer-extended.featured') }}</h3>
            </div>
            ...
            <div class="col-md-2 col-6 text-center mb-3 my-auto">
                <a href="https://www.pcgamesn.com/subnautica/subnautica-nitrox-mod" target="_blank">
                    <svg width="132px" height="24px" viewbox="0 0 162 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="col-md-2 col-6 text-center mb-3 my-auto">
                <a href="https://www.thegamer.com/subnautica-how-play-multiplayer-nitrox-mod/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" id="_15_-_TheGamer" data-name="15 - TheGamer" viewbox="0 0 316.58 66.71">
                        <defs>
                            <style>
                                .cls-1,
                                .cls-2 {
        ...
        <div class="row d-flex">
            <div class="col-12 mb-4 ">
                ...
                <ol class="small opacity-5 pl-3">
                    <li id="footnote-1">{{ __('footer.footer-extended.footnote_1') }}</li>
                    <li id="footnote-2">{{ __('footer.footer-extended.footnote_2') }}</li>
                    <li id="footnote-3">{{ __('footer.footer-extended.footnote_3') }}</li>
                </ol>
            </div>
        </div>
    </div>
