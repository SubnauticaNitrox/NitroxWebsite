        ...
        <div class="row mt-5 pt-3 d-flex justify-content-center wizard-container">
            <div class="col-md-12 p-5 text-left">
                ...
                <div class="wizard-main pl-5 pr-5 pb-4">
                    ...
                    <p class="pt-4">
                        Go to your Subnautica install location, open the folder "Subnautica Data" and <b>delete the folder named "Managed"</b>.
                    </p>

                    <p>Go to the Steam Library, find Subnautica then right click Properties, then go to LOCAL FILES and VERIFY INTEGRITY OF GAME FILES</p>
                </div>
                ...
                <div class="wizard-footer border-top mt-4 pt-4 d-flex justify-content-between">
                    ...
                    <a href="{{ route('wizard.steam.update.step3') }}" class="btn btn-secondary text-right">Continue</a>
                </div>
