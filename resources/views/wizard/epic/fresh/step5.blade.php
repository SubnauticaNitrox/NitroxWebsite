            ...
            <div class="col-md-12 p-5 text-left">
                ...
                <div class="wizard-main pl-5 pr-5">
                  <h6>Step 5</h6>
                    ...
                    <h6>Typically:</h6>
                    <kbd>C:\Program Files\Epic Games\Subnautica</kbd>
                ...
                <div class="wizard-footer border-top mt-4 pt-4 d-flex justify-content-between">
                    <a href="{{ route('wizard.epic.step4') }}" class="btn btn-outline-secondary">Back</a>
                    <a href="{{ route('wizard.epic.done') }}" class="btn btn-secondary text-right">Continue</a>
                </div>
