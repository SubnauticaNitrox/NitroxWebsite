    ...
    <div class="container">
        <div class="row mt-5 pt-3 d-flex justify-content-center wizard-container">
            <div class="col-md-12 p-5 text-left">
                ...
                <h6>Step 1</h6>
                <h2 class="font-weight-bold">Which platform are you playing on?</h2>

                <div class="row pt-5 pb-5">
                    <div class="col-6">
                        <a href="{{ route('wizard.steam.step2') }}" class="btn btn-outline-secondary w-100 platform-logos">
                    ...
                    <div class="col-6">
                        <a href="{{ route('wizard.epic.step2') }}" class="btn btn-outline-secondary w-100 platform-logos">
