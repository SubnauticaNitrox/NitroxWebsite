...
return [
    [
        "version" => "1.8.1.0",
        "released" => "2026-01-07T20:00:00Z",
        "permalink" => "https://nitrox.rux.gg/pages/changelog#nitrox%C2%A01-8-1-0",
       "patchnotes" => [
            "# In Game",
            ...
            "Fixed a bug where launcher could crash with a FileNotFound/Security error",
            "# Server",
            "Added an option to disable the behavior that gives admin permissions to local players (to avoid issues with proxies)",
            "Fixed the --data-path argument that allows you to set the absolute path where Nitrox stores files (logs, cache, save files, ...)",
            "Fixed a bug that prevented the server from starting due to a DirectoryNotFound error"
        ],
    ],
    [
        "version" => "1.8.0.1",
